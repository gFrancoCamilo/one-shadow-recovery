...
pub struct Store {
    ...
    pub last_block: Digest,
}

impl Store {
    pub fn new(path: &str, last_block: Digest) -> StoreResult<Self> {
        ...
        Ok(Self { channel: tx , last_block: last_block })
    }
    ...
    pub fn update_last_block(&mut self, digest: Digest) {
        self.last_block = digest;
    }
}
